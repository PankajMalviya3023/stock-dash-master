...
app.layout = html.Div(
    [
        html.Div(
            [
                # Navigation
                html.Marquee("Welcome to the Stock Dashboard!", className="start"),
                html.Div([
                    html.P("Input stock code: "),
                    html.Div([
                        dcc.Input(id="dropdown_tickers", type="text",placeholder="ENTER CODE"),
...
def update_data(n, val):  # inpur parameter(s)
    if n == None:
        return "Hey! Please enter a correct stock code to get details.", "https://myfinassets.com/media/2020/01/futures-vs-forex-4-750x416.jpg", "Stocks", None, None, None
        # raise PreventUpdate
    else:
        if val == None:
            raise PreventUpdate
